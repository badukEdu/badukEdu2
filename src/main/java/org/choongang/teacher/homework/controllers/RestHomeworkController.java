...
public class RestHomeworkController {
    ...
    public String getMemberData(@RequestParam("option") String selectedOption) {
        ...
        for (Member member : members) {
            tableData.append("<tr>");
            tableData.append("<td><input type='checkbox' name='checkMember' th:id='*{'chk_' + num} th:value=*{num}>").append("</td>"); // 체크박스
    ...
    public String getHomeworkData(@RequestParam("option") String selectedOption) {
        ...
        for (Homework homework : homeworks) {
            tableData.append("<tr>");
            tableData.append("<td><input type='checkbox' name='checkHomework' th:id='*{'chk_' + num} th:value=*{num}>").append("</td>"); // 체크박스
